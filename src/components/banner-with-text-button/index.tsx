      ...
      <BannerWrapper className="text-center">
        <BannerContent>
          ...
          <BoxCenter className="class-box">
            ...
            <a
              href="https://api.whatsapp.com/send?phone=5527992044443&text=Ol%C3%A1,%20vim%20do%20site%20e%20tenho%20interesse%20em%20seus%20produtos!"
              target="_blank"
            ...
            <a
              href="https://www.instagram.com/digitalwhile.ofc"
              target="_blank"
              className="btn btn-blue"
            >
              Instagram
